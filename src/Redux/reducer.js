...
export function sumRepSales() {
  return {
    type: SUM_REP_SALES,
    payload: axios.get("/api/sum-rep-sales").then((res) => res.data),
  };
}
...
export function currentRevenue() {
  return {
    type: UPDATE_REVENUE,
    payload: axios.get("/api/revenue").then((res) => res.data),
  };
}
export function updateFirstName(firstname) {
  return {
    type: UPDATE_FIRSTNAME,
    payload: axios.put("/auth/user", {}).then((res) => res.data),
  };
}
...
export function countUsers() {
  return {
    ...
    payload: axios.get("/api/users-count").then((res) => res.data),
  };
}
export function countMessages() {
  return {
    type: UPDATE_MESSAGES_COUNT,
    payload: axios.get("/api/messages").then((res) => res.data),
  };
}
export function countSales() {
  return {
    type: UPDATE_SALES_COUNT,
    payload: axios.get("/api/sales").then((res) => res.data),
  };
}
